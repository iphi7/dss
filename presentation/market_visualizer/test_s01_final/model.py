...
class Config:
    seed: int = 42
    n_days: int = 1260
    # ===== market_visualizer 用ログ =====
    # visual_log_enabled=False のときはモデル挙動・返り値に影響しない。
    visual_log_enabled: bool = False
    visual_log_stride: int = 1
    visual_log_top_orders: int = 200
    visual_log_firm_limit: int = 0       # 0 = 全企業
    visual_log_investor_limit: int = 0   # 0 = 全投資家
    visual_log_subjective_edges_per_investor: int = 30
