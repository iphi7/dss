...
CONFIGS={
    # Round2: X04/X03周辺を中心に、rebalを弱めてACFを戻す。
    # ただし immediate fear/asym は抑え、短期decile10過剰を避ける。
    'X07_X04_less_rebal_more_acf': cfg(
        idio_vol=0.0082, exog_common_sigma=0.0045,
        ...
        asym_pi_scale=0.82, down_ewma_decay=0.60,
        stoploss_universal_scale=0.006, stoploss_universal_threshold=0.0045,
        portfolio_rebalance_rate=0.0003,
    ),
    'X08_X04_no_rebal_soft_fear': cfg(
        idio_vol=0.0078, exog_common_sigma=0.0042,
        exog_common_jump_prob=0.007, exog_common_jump_sigma=0.038,
        rare_shock_prob=0.022, rare_shock_sigma=0.14,
        participation_vol_power=1.25, impact_activity_scale=1.45, impact_activity_clip=3.10,
        asym_pi_scale=0.70, down_ewma_decay=0.56,
        stoploss_universal_scale=0.004, stoploss_universal_threshold=0.005,
        portfolio_rebalance_rate=0.0,
    ),
    'X09_X03_less_short_leverage': cfg(
        ...
        asym_pi_scale=0.65, down_ewma_decay=0.58,
        stoploss_universal_scale=0.006, stoploss_universal_threshold=0.0048,
        portfolio_rebalance_rate=0.00045,
    ),
    'X10_X05_less_rebal_activity': cfg(
        idio_vol=0.0078, exog_common_sigma=0.0043,
        exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040,
        rare_shock_prob=0.026, rare_shock_sigma=0.15,
        participation_vol_power=1.25, impact_activity_scale=1.55, impact_activity_clip=3.00,
        asym_pi_scale=0.75, down_ewma_decay=0.57,
        stoploss_universal_scale=0.006, stoploss_universal_threshold=0.0048,
        portfolio_rebalance_rate=0.0015,
    ),
    'X11_R03_softened_tiny_rebal': cfg(
        idio_vol=0.0072, exog_common_sigma=0.0038,
        exog_common_jump_prob=0.006, exog_common_jump_sigma=0.038,
        rare_shock_prob=0.026, rare_shock_sigma=0.14,
        participation_vol_power=1.05, impact_activity_scale=1.05, impact_activity_clip=2.60,
        asym_pi_scale=0.55, down_ewma_decay=0.52,
        stoploss_universal_scale=0.003, stoploss_universal_threshold=0.0055,
        portfolio_rebalance_rate=0.00025,
    ),
    'X12_tail_boost_low_fear': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0043,
        exog_common_jump_prob=0.006, exog_common_jump_sigma=0.036,
        rare_shock_prob=0.040, rare_shock_sigma=0.16,
        participation_vol_power=1.20, impact_activity_scale=1.30, impact_activity_clip=3.00,
        asym_pi_scale=0.60, down_ewma_decay=0.55,
        stoploss_universal_scale=0.003, stoploss_universal_threshold=0.0055,
        portfolio_rebalance_rate=0.0004,
    ),
}
