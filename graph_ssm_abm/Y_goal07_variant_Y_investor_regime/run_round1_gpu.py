...
CONFIGS={
    # Y01: X09をベースに、リスク選好投資家だけがストレス後に参加率/注文量を上げる。
    'Y01_X09_pref_activity': cfg(
        ...
        asym_pi_scale=0.50, down_ewma_decay=0.58,
        stoploss_universal_scale=0.002, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.00045,
        investor_stress_scale=1.0, investor_stress_decay=0.94, investor_stress_threshold=0.0, investor_stress_clip=3.0,
        risk_pref_participation_scale=0.35, risk_pref_size_scale=0.25,
        risk_averse_withdraw_scale=0.18,
    ),
    # Y02: 中期を強めに。20d改善狙いだが短期悪化リスクあり。
    'Y02_X09_pref_activity_strong': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0045,
        exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040,
        rare_shock_prob=0.022, rare_shock_sigma=0.14,
        participation_vol_power=1.30, impact_activity_scale=1.65, impact_activity_clip=3.60,
        asym_pi_scale=0.40, down_ewma_decay=0.60,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.00045,
        investor_stress_scale=1.3, investor_stress_decay=0.96, investor_stress_threshold=0.0, investor_stress_clip=3.5,
        risk_pref_participation_scale=0.55, risk_pref_size_scale=0.35,
        risk_averse_withdraw_scale=0.25,
    ),
    # Y03: リスク選好投資家の逆張り買いを追加し、短期売り過剰を抑える。
    'Y03_X09_contrarian_pref': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0045,
        exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040,
        rare_shock_prob=0.022, rare_shock_sigma=0.14,
        participation_vol_power=1.30, impact_activity_scale=1.65, impact_activity_clip=3.50,
        asym_pi_scale=0.38, down_ewma_decay=0.60,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.00045,
        investor_stress_scale=1.2, investor_stress_decay=0.95, investor_stress_threshold=0.0, investor_stress_clip=3.5,
        risk_pref_participation_scale=0.45, risk_pref_size_scale=0.30,
        risk_averse_withdraw_scale=0.25, risk_pref_buy_tilt=0.20,
    ),
    # Y04: X04系。ACF弱めだがdecile形状が近いので、投資家機構で中期だけ戻せるか。
    'Y04_X04_pref_activity': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0045,
        exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040,
        rare_shock_prob=0.022, rare_shock_sigma=0.14,
        participation_vol_power=1.25, impact_activity_scale=1.45, impact_activity_clip=3.20,
        asym_pi_scale=0.55, down_ewma_decay=0.62,
        stoploss_universal_scale=0.002, stoploss_universal_threshold=0.006,
    ...
    # Y05: リスク選好が買いも売りも厚く出す speculative turnover 型。
    'Y05_speculative_turnover': cfg(
        ...
        participation_vol_power=1.15, impact_activity_scale=1.35, impact_activity_clip=3.20,
        asym_pi_scale=0.30, down_ewma_decay=0.65,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.0002,
        investor_stress_scale=1.5, investor_stress_decay=0.96, investor_stress_threshold=0.0, investor_stress_clip=4.0,
        risk_pref_participation_scale=0.70, risk_pref_size_scale=0.45,
        risk_averse_withdraw_scale=0.15, risk_pref_buy_tilt=0.10, risk_pref_sell_tilt=0.08,
    ),
}
