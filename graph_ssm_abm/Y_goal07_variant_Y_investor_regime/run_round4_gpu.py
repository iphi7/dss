...
CONFIGS={
    # Round4: Round3でtailがclipに抑えられている可能性があるため、clipを広げる。
    # 中心部はjump頻度を低く保って守る。
    'Y15_Y12_wideclip_balanced': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0044,
        exog_common_jump_prob=0.0015, exog_common_jump_sigma=0.120, exog_common_clip=0.160,
        ...
        asym_pi_scale=0.30, down_ewma_decay=0.58,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.0008,
        investor_stress_scale=1.10, investor_stress_decay=0.955, investor_stress_threshold=0.0, investor_stress_clip=3.2,
        risk_pref_participation_scale=0.35, risk_pref_size_scale=0.24,
        risk_averse_withdraw_scale=0.28,
    ),
    # Y14に近く、ACF/10dを保ちながらclipだけ広げる。
    'Y16_Y14_wideclip_keepacf': cfg(
        idio_vol=0.0080, exog_common_sigma=0.0045,
        exog_common_jump_prob=0.0018, exog_common_jump_sigma=0.110, exog_common_clip=0.160,
        rare_shock_prob=0.0040, rare_shock_sigma=0.28,
        participation_vol_power=1.23, impact_activity_scale=1.42, impact_activity_clip=3.20,
        asym_pi_scale=0.42, down_ewma_decay=0.60,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.0008,
        investor_stress_scale=1.20, investor_stress_decay=0.958, investor_stress_threshold=0.0, investor_stress_clip=3.4,
        risk_pref_participation_scale=0.45, risk_pref_size_scale=0.30,
        risk_averse_withdraw_scale=0.30,
    ),
    # よりrare/large。尖度優先だが、decile10過大を避けるためstress/asymは弱める。
    'Y17_disaster_wideclip_lowlev': cfg(
        idio_vol=0.0078, exog_common_sigma=0.0042,
        exog_common_jump_prob=0.0009, exog_common_jump_sigma=0.180, exog_common_clip=0.220,
        rare_shock_prob=0.0025, rare_shock_sigma=0.34,
        participation_vol_power=1.12, impact_activity_scale=1.25, impact_activity_clip=3.00,
        asym_pi_scale=0.22, down_ewma_decay=0.55,
        stoploss_universal_scale=0.0, stoploss_universal_threshold=0.006,
        portfolio_rebalance_rate=0.0008,
        investor_stress_scale=0.95, investor_stress_decay=0.950, investor_stress_threshold=0.0, investor_stress_clip=3.0,
        risk_pref_participation_scale=0.28, risk_pref_size_scale=0.20,
        risk_averse_withdraw_scale=0.25, risk_pref_buy_tilt=0.010,
    ),
}
