...
CONFIGS={
 'R12_tiny_rebal_active': cfg(idio_vol=0.0080, exog_common_sigma=0.0045, exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040, rare_shock_prob=0.022, rare_shock_sigma=0.14, participation_vol_power=1.25, impact_activity_scale=1.60, impact_activity_clip=3.20, asym_pi_scale=1.50, down_ewma_decay=0.65, stoploss_universal_scale=0.040, stoploss_universal_threshold=0.003, portfolio_rebalance_rate=0.001, portfolio_cash_target=0.05),
 'R13_tiny_rebal_lev': cfg(idio_vol=0.0080, exog_common_sigma=0.0045, exog_common_jump_prob=0.008, exog_common_jump_sigma=0.040, rare_shock_prob=0.022, rare_shock_sigma=0.14, participation_vol_power=1.20, impact_activity_scale=1.40, impact_activity_clip=3.00, asym_pi_scale=1.80, down_ewma_decay=0.70, stoploss_universal_scale=0.070, stoploss_universal_threshold=0.003, portfolio_rebalance_rate=0.001, portfolio_cash_target=0.05),
}
