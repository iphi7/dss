...
CONFIGS={
 'R05_short_memory_vol': cfg(idio_vol=0.0070, exog_common_sigma=0.0038, exog_common_jump_prob=0.006, exog_common_jump_sigma=0.035, participation_vol_power=1.10, impact_activity_scale=1.10, impact_activity_clip=2.50, asym_pi_scale=1.40, down_ewma_decay=0.65, stoploss_universal_scale=0.030),
 'R06_short_memory_lev': cfg(idio_vol=0.0070, exog_common_sigma=0.0038, exog_common_jump_prob=0.006, exog_common_jump_sigma=0.035, participation_vol_power=1.10, impact_activity_scale=1.10, impact_activity_clip=2.50, asym_pi_scale=1.60, down_ewma_decay=0.65, stoploss_universal_scale=0.060, stoploss_universal_threshold=0.003),
 'R07_more_activity': cfg(idio_vol=0.0070, exog_common_sigma=0.0038, exog_common_jump_prob=0.006, exog_common_jump_sigma=0.035, participation_vol_power=1.25, impact_activity_scale=1.40, impact_activity_clip=3.00, asym_pi_scale=1.40, down_ewma_decay=0.68, stoploss_universal_scale=0.040, stoploss_universal_threshold=0.003),
 'R08_tail_lev': cfg(idio_vol=0.0068, exog_common_sigma=0.0035, exog_common_jump_prob=0.010, exog_common_jump_sigma=0.045, rare_shock_prob=0.022, rare_shock_sigma=0.14, participation_vol_power=1.05, impact_activity_scale=1.00, impact_activity_clip=2.50, asym_pi_scale=1.60, down_ewma_decay=0.62, stoploss_universal_scale=0.060, stoploss_universal_threshold=0.003),
}
