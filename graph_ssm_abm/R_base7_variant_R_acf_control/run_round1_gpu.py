...
CONFIGS={
 'R01_no_mom_lowvol': cfg(),
 'R02_mom005': cfg(momentum_score_weight=0.05),
 'R03_more_tail': cfg(momentum_score_weight=0.0, exog_common_jump_prob=0.006, exog_common_jump_sigma=0.040, rare_shock_prob=0.020, rare_shock_sigma=0.13),
 'R04_more_leverage': cfg(momentum_score_weight=0.0, stoploss_universal_scale=0.030, asym_pi_scale=1.50, down_ewma_decay=0.60),
}
...
def main():
    ...
    pd.DataFrame(all_roll).to_csv(ROOT/'rolling_metrics_round1.csv',index=False)
