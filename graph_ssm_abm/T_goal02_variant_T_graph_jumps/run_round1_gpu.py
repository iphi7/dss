...
CONFIGS={
    'T01_signed_local': cfg(graph_jump_prob=0.0012, graph_jump_sigma=0.050, graph_jump_df=2.6, graph_jump_clip=0.16, graph_jump_neg_prob=0.62, graph_jump_sources=2, graph_jump_degree_power=1.1, graph_jump_spread=0.50, graph_jump_hops=2, graph_jump_mode='signed'),
    'T02_diffuse_signed': cfg(graph_jump_prob=0.0010, graph_jump_sigma=0.060, graph_jump_df=2.5, graph_jump_clip=0.17, graph_jump_neg_prob=0.65, graph_jump_sources=3, graph_jump_degree_power=1.4, graph_jump_spread=0.70, graph_jump_hops=3, graph_jump_mode='signed'),
    'T03_mixed_sign': cfg(graph_jump_prob=0.0013, graph_jump_sigma=0.055, graph_jump_df=2.6, graph_jump_clip=0.16, graph_jump_neg_prob=0.62, graph_jump_sources=2, graph_jump_degree_power=1.2, graph_jump_spread=0.60, graph_jump_hops=2, graph_jump_mode='abs_noise'),
    'T04_short_residual': cfg(graph_jump_prob=0.0010, graph_jump_sigma=0.050, graph_jump_df=2.8, graph_jump_clip=0.15, graph_jump_neg_prob=0.62, graph_jump_sources=2, graph_jump_degree_power=1.2, graph_jump_spread=0.55, graph_jump_hops=2, graph_jump_mode='residual', graph_jump_residual_decay=0.35, graph_jump_residual_scale=0.35),
}
...
def main():
    ...
    append('## Round1: グラフ伝播型ジャンプ機構の比較\n\nR03をベースに、企業ネットワーク上の局所ショック源からジャンプを伝播させる。Q-Qの不自然な折れ、絶対リターンtail、return^2 ACF、十分位別leverageを確認する。\n\n実データ参照:\n\n'+pd.DataFrame([real]).to_markdown(index=False))
    all_rows=[]; aggs=[]
