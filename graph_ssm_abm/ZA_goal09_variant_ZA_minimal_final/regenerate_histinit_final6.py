"""
ZA-FINAL6 (Z05: キャパシティ制約+状態依存ファイアセール版) の histinit 10seed 生成。
...
OUTROOT = ZA / 'results_fix6_2' / 'Z05_final' / 'histinit'
...
def main():
    ...
    for seed in range(1, 11):
        ...
        cfg = Config(**{**ZA_FINAL6_PARAMS, 'seed': seed, 'n_days': n_days,
