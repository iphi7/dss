"""
ZA-FINAL3 (P01: レベル微調整版) の histinit 10seed 生成。
...
from za_final_config import ZA_FINAL3_PARAMS  # noqa: E402

OUTROOT = ZA / 'results_fix4_8' / 'P01_d32_mr60' / 'histinit'
...
def main():
    ...
    for seed in range(1, 11):
        ...
        cfg = Config(**{**ZA_FINAL3_PARAMS, 'seed': seed, 'n_days': n_days,
