"""
ZA-FINAL5 (S01: ノイズ削減でバブル抑制版) の histinit 10seed 生成。
...
from za_final_config import ZA_FINAL5_PARAMS  # noqa: E402

OUTROOT = ZA / 'results_fix5_3' / 'S01_final' / 'histinit'
...
def main():
    ...
    for seed in range(1, 11):
        ...
        cfg = Config(**{**ZA_FINAL5_PARAMS, 'seed': seed, 'n_days': n_days,
