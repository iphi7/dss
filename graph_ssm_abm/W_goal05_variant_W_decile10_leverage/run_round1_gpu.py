...
CONFIGS={
    'W00_V06_recheck': cfg(),
    # reduce direct down-triggered mechanisms
    'W01_no_fear': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.70, down_ewma_decay=0.40),
    'W02_low_asym': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.45, down_ewma_decay=0.35, participation_vol_power=0.72, impact_activity_scale=0.55),
    'W03_min_asym_keep_acf': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.25, down_ewma_decay=0.30, participation_vol_power=0.80, impact_activity_scale=0.70),
}
...
def main():
    ...
    append('## Round1: 分位10 leverageを弱める\n\nV06/R03では高ボラ十分位10のleverageが負に強すぎる。stoploss/fear/asym_pi/down memoryを弱め、1d〜20dのdecile10 leverageを実データ側へ戻す。')
    all_rows=[]; aggs=[]
