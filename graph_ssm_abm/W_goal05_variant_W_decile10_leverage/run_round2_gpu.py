...
CONFIGS={
    # W02/W03 midpoint: target decile10 5d around real (-0.21) while keeping some sq_acf.
    'W04_mid_asym035': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.35, down_ewma_decay=0.33, participation_vol_power=0.76, impact_activity_scale=0.62),
    'W05_mid_asym040': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.40, down_ewma_decay=0.35, participation_vol_power=0.76, impact_activity_scale=0.62),
    'W06_mid_more_sq': cfg(stoploss_universal_scale=0.0, asym_pi_scale=0.38, down_ewma_decay=0.38, participation_vol_power=0.82, impact_activity_scale=0.72),
}
...
def main():
    ...
    append('## Round2: W02/W03中間でdecile10とsq_acfの妥協点探索\n\nRound1ではW03がdecile10をよく抑えたがsq_acfが低すぎた。W02/W03の中間で、decile10 5dを実データ近傍に置きつつsq_acfを戻す。')
    all_rows=[]; aggs=[]
