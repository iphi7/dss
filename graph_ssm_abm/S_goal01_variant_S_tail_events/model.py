...
class Config:
    ...
    # iidに近い稀な市場ジャンプ。ACFを増やさず、最上位tail/尖度を補う目的。
    market_tail_jump_prob: float = 0.0
    market_tail_jump_sigma: float = 0.0
    market_tail_jump_df: float = 2.5
    market_tail_jump_clip: float = 0.20
    market_tail_jump_neg_prob: float = 0.50
