...
CONFIGS={
    'S10_disaster_light': cfg(market_tail_jump_prob=0.00045, market_tail_jump_sigma=0.130, market_tail_jump_df=2.2, market_tail_jump_clip=0.24, market_tail_jump_neg_prob=0.70),
    'S11_disaster_mix': cfg(market_tail_jump_prob=0.00075, market_tail_jump_sigma=0.105, market_tail_jump_df=2.2, market_tail_jump_clip=0.22, market_tail_jump_neg_prob=0.68),
}
